...
log_file_exceptions = open("/Users/shreejakatama/Downloads/Internship/Folder Code/Log File Exceptions.txt", 'a', encoding = "utf-8")
log_file_success = open("/Users/shreejakatama/Downloads/Internship/Folder Code/Log File Success.txt", 'a', encoding = "utf-8")
        ...
        for r in range(no_of_rows):
            ...
            if row_data :
                ...
                for i in range(len(row_data)) :
                    if not row_data[i].isdigit():
                        subject_details[column_headers[i]] = row_data[i]
                    else:
                        subject_details[column_headers[i]] = int(row_data[i])
